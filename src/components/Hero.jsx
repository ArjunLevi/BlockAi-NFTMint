        ...
        <div className="flex flex-col justify-center items-center">
          ...
          >
            ...
            <div className="flex flex-col font-semibold">
              ...
              <span className="text-[#e32970] text-xs">Arjun</span>
            </div>
          </a>

          <p className="text-white text-sm font-medium text-center">
            Arjun software engineer in
            2020. <br /> Over the years, he has grown full-blown skills in
            JavaScript stacks such as <br /> React, Solidity,
            blockchain.
          </p>
          ...
          <ul className="flex flex-row justify-center space-x-2 items-center my-4">
            ...
            <a
              className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full mx-2"
              href="https://twitter.com/Arjun29394991?t=9VuqeaCdd7bNkC8qv8sEyA&s=09"
            >
              <img className="w-7 h-7" src={twitter} alt="twitter" />
            </a>
            <a
              className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full mx-2"
              href="https://medium.com/@66naga18"
            >
          ...
          >
            <span className="text-xs font-bold">{nfts.length}/20</span>
          </div>
        </div>
      </div>
    </div>
